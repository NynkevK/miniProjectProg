...
class BillingDutch(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        self.billingViewDutch(controller)


    def billingViewDutch(self, controller):
        ...
        self._informationLabel = tk.Label(frameLeft, text="Vul hier uw gegevens in \n"
                                                   "voor het automatisch factureren",
        ...
        def billing_format():
            ...
            billingInput = ["Naam:", "Achternaam", "E-mail:", "Rekeningnummer:"]
    ...
    def Send(self,entries):
        ...
        for item in values:
            if not item:
                self.ShowMessage("één of meerdere velden \n zijn incompleet")
                return
        ...
        #     factudingesen
        self.ShowMessage("U wordt automatisch \n gefactureerd!")
        ...
        email.SetSubject("Automatische facturatie Parkeergarage Kruisstraat")
        email.AppendEmail(emailAddress)
        email.SetMessage("In de bijlage vindt u uw automatisch gegeneerde facturatie!")
    ...
    def Update(self,data):
        """..."""
        if data is None:
            self.controller.show_frame("PayDutch")
            return
