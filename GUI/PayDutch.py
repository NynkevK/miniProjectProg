...
class PayDutch(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        self.payViewDutch(controller)


    def payViewDutch(self, controller):
        ...
        informatieLabel = tk.Label(frameLeft, text="Vul hier uw kenteken in\n om te betalen",
    ...
    def ProcessLicensePlate(self,entries):
        ...
        if license is not None:
            ...
            if not name or lastName or email or accountNumber:
                ...
                self.controller.show_frame("BillingDutch",license)

            else:
                print("U wordt doorverwezen!")
